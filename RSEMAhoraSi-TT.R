...
plotMDS(y$counts, main = "MDS conteos",col=c(rep("#008000",3),rep("#00B300",3),rep("#000080",3),rep("#0000B7",3),rep("#760000",3),rep("#C20000",3),rep("#800080",3),rep("#C900C7",3)),fontsize_number = 8)
