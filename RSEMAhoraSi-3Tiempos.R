...
names(files) <- c("FC1_1","FC1_2","FC1_3","FF1_1","FF1_2","FF1_3", "FC24_1","FC24_2","FC24_3","FF24_1","FF24_2","FF24_3", "FC72_1","FC72_2","FC72_3","FF72_1","FF72_2","FF72_3" )
...
plotMDS(y$counts, main = "MDS conteos",col=c(rep("#008000",3),rep("#00B300",3),rep("#760000",3),rep("#C20000",3),rep("#800080",3),rep("#C900C7",3)),fontsize_number = 8)
