...
setwd("C:/Users/gusta/OneDrive/Escritorio/Resultados Tesis/ElBueno")
...
write.csv(gos, file = "GOT.csv")

bar <- ggbarplot(plotgos, "name", "transcripts",
          fill = "ontology", 
          color = "ontology",
          xlab = "Nombre",
          ylab = "Número de transcritos",
...
xgenus[(Number <= 500), Genus := "Others"]
